...
impl Lang {
    pub fn agent_off(self) -> &'static str {
        match self {
            Self::English => "Off",
            Self::Bokmal | Self::Nynorsk | Self::Swedish | Self::Danish => "Av",
            Self::German => "Aus",
            Self::Dutch => "Uit",
            Self::French => "Désactivé",
            Self::Spanish => "Desactivado",
            Self::Italian => "Disattivato",
            Self::Portuguese => "Desligado",
            Self::Finnish => "Pois",
            Self::Polish => "Wyłączony",
            Self::Icelandic => "Slökkt",
            Self::Czech => "Vypnuto",
        }
    }
...
const NB: UiText = UiText {
    ...
    agent_menu: "Agent",
    enable_agent: "Utforsk",
    agent_enabled: "Rediger",
    font_label: "Skrift",
...
const SV: UiText = UiText {
    ...
    agent_menu: "Agent",
    enable_agent: "Utforska",
    agent_enabled: "Redigera",
    font_label: "Typsnitt",
...
const DE: UiText = UiText {
    ...
    agent_menu: "Agent",
    enable_agent: "Erkunden",
    agent_enabled: "Bearbeiten",
...
const NL: UiText = UiText {
    ...
    agent_menu: "Agent",
    enable_agent: "Verkennen",
    agent_enabled: "Bewerken",
...
const FR: UiText = UiText {
    ...
    agent_menu: "Agent",
    enable_agent: "Explorer",
    agent_enabled: "Modifier",
    font_label: "Police",
...
const ES: UiText = UiText {
    ...
    agent_menu: "Agente",
    enable_agent: "Explorar",
    agent_enabled: "Editar",
    font_label: "Fuente",
...
const IT: UiText = UiText {
    ...
    agent_menu: "Agente",
    enable_agent: "Esplora",
    agent_enabled: "Modifica",
...
const PL: UiText = UiText {
    ...
    agent_menu: "Agent",
    enable_agent: "Eksploruj",
    agent_enabled: "Edytuj",
    font_label: "Czcionka",
...
const CS: UiText = UiText {
    ...
    agent_menu: "Agent",
    enable_agent: "Prozkoumat",
    agent_enabled: "Upravit",
    font_label: "Písmo",
